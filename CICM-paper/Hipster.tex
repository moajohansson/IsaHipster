...
Below we give two typical use cases for Hipster. In both examples, Hipster has been instantiated with a routine reasoning tactic which applies simplification followed by Metis, and 
