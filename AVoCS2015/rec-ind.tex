...
%
In the case of \texttt{\fontfamily{lmvtt}\selectfont sorted}, cases are broken down into more detailed ones whilst \texttt{\fontfamily{lmvtt}\selectfont last} is partially defined, meaning the induction scheme it gives rise to is to be completed with its missing case for empty lists, as the corresponding induction scheme depicts:
