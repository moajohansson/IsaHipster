...
%
Instead of synthesising a series of possible simultaneous induction schemes, recursion induction gives us an immediate choice which is also closer to the problem at hand.
