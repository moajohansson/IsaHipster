...
Overall, the rate of fully automated provability on the benchmark set is 90\% ($(67+29+13+12)/(71+38+14+12)$); considering partially automated problems as well, the rate is 97\%.
%
...
%
In Table \ref{tab:rec-ind}, problems solved by structural induction are those for which both the main theorem and any required auxiliary lemma only needed structural induction in their respective solutions.%proofs?
%
