...
lemma unknown [thy_expl]: "zip2 (prop_85.append x y) (prop_85.rev x) = zip2 x (prop_85.rev x)"
oops

lemma unknown [thy_expl]: "zip2 (prop_85.rev x) (prop_85.append x y) = zip2 (prop_85.rev x) x"
oops

lemma unknown [thy_expl]: "zip2 (prop_85.append x x) (prop_85.rev x) = zip2 x (prop_85.rev x)"
oops

lemma unknown [thy_expl]: "zip2 (prop_85.rev x) (prop_85.append x x) = zip2 (prop_85.rev x) x"
oops
...
lemma lemma_ak [thy_expl]: "len (rev x3) = len x3"
by (hipster_induct_schemes len.simps rev.simps append.simps)
