...
lemma lemma_ap [thy_expl]: "plus (plus x2 y2) (plus z2 y2) =
plus (plus x2 z2) (plus y2 y2)"
by (hipster_induct_schemes plus.simps)

lemma lemma_aq [thy_expl]: "plus (plus x3 y3) (plus z3 z3) =
plus (plus x3 z3) (plus z3 y3)"
by (hipster_induct_schemes plus.simps)

lemma lemma_ar [thy_expl]: "plus (plus x2 y2) (S z2) =
plus (plus x2 z2) (S y2)"
by (hipster_induct_schemes plus.simps)
